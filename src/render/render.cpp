...
void renderPointCloud(pcl::visualization::PCLVisualizer::Ptr& viewer, pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud, std::string name, Color color)
{
...
void renderPointCloud(pcl::visualization::PCLVisualizer::Ptr& viewer, pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud, std::string name, Color color)
{
